...
export async function generateWordOutput(momData: MoMData): Promise<Buffer> {
  ...
  sections.push(
    new Paragraph({
      children: [
        new TextRun({ text: "⚠  AI-Generated Content — ", bold: true, size: 17, font: "Calibri", color: AMBER }),
        new TextRun({
          text: "This document has been generated by artificial intelligence based on the provided meeting transcript. "
          ...
          size: 17, font: "Calibri", color: AMBER,
        }),
      ],
