                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-amber-700 dark:text-amber-400 leading-relaxed">
                    {job.error_message?.includes("quota")
                      ? "The free-tier quota for Google Gemini AI has been exhausted. The system automatically tried all available fallback models — all are on the same quota limit."
                      : "Google's Gemini AI is experiencing high demand right now. The system automatically retried across 3 different models — all returned the same overload signal."}
                  </p>
                  <p className="text-sm text-amber-700 dark:text-amber-400 leading-relaxed">
                    <span className="font-semibold">Please come back in about 10 minutes</span> and
                    click <span className="font-semibold">Retry</span> — quota resets on a rolling
                    window and the job will process normally once capacity is restored.
                  </p>
                </div>
              </div>
            </div>
